...
public class Main {
    ...
    public static void TestFull() {
        ...
        ZSWAPIV1.KVPair[] collectionAMetadata = new ZSWAPIV1.KVPair[]{
                CreateVariantFieldValue("name", "string","北京知名地"),
                CreateVariantFieldValue("description", "string","一个关于北京知名地的数字艺术品组合"),
        ...
        ZSWAPIV1.KVPair[] itemTemplateACommonMetadata = new ZSWAPIV1.KVPair[]{
                CreateVariantFieldValue("city", "string","北京市"),
                CreateVariantFieldValue("district", "string","朝阳区"),
        ...
        ZSWAPIV1.KVPair[] itemAImmutableMetadata = new ZSWAPIV1.KVPair[]{
                CreateVariantFieldValue("name", "string","北京大学"),
